...
- **Driver** — accept jobs, broadcast GPS, manage scheduled bookings
- **Admin** — manage users, drivers, and platform activity

`Flutter` `Dart` `Firebase` `Firestore` `Google Maps API` `SendGrid` `Multi-role auth`
